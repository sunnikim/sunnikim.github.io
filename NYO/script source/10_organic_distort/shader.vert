...
//     float distortion = sin(positionVec4.x * frequency + u_time * 0.1);
//     positionVec4.x += distortion * aNormal.x * amplitude;

//     float Ydistortion = cos(positionVec4.y * frequency + u_time * 0.1);
//     positionVec4.y += Ydistortion * aNormal.y * amplitude;

//     float Zdistortion = cos(positionVec4.z * frequency + u_time * 0.1);
